...
py main.py                          :: 실행 — 창 없이 이벤트만(stdout, 기본, 2026-08-31)
py main.py --cam                    :: 카메라·판정 계기판 창을 켠 채 시작 (현장 점검용)
...
| 명령 | 용도 |
|---|---|
| `py main.py` | 엔진 — 창 없이 이벤트만(stdout) 시작 (공식 실행 — 시스템 파이썬) |
| `py main.py --cam` | 카메라·계기판 창을 켠 채 시작 (현장 점검용) |
